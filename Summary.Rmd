...
## Spatial analysis
```{r echo=FALSE,results="asis"}
  points <- st_as_sf(x = all_data$trees %>% mutate(Condition=fct_relevel(Condition,"Missing","Moribund","Poor","Fair","Good")), coords = c("N", "E"), crs = "+proj=utm +zone=10 +north +datum=WGS84 +units=m +no_defs")
