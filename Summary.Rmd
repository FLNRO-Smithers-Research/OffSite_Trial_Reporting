...
## Spatial analysis
```{r echo=FALSE,results="asis"}
  points <- st_as_sf(x = all_data$trees, coords = c("N", "E"), crs = "+proj=utm +zone=10 +north +datum=WGS84 +units=m +no_defs")
  
  #TODO: Reorder ledged
  mapview(points["Condition"], col.regions = c("Yellow", "Green", "Blue", "Red", "Orange"), lwd = 0, cex = 5)
```
# Temperature
```{r echo=FALSE,results="asis"}
